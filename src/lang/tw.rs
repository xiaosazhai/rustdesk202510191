...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "狀態"),
        ("Your Desktop", "您的迎客桌面"),
        ("desk_tip", "您可以透過此 ID 及密碼存取您的迎客桌面"),
        ("Password", "密碼"),
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ...
        ("Control Remote Desktop", "控制遠端迎客桌面"),
        ("Transfer file", "傳輸檔案"),
        ("Connect", "連線"),
        ...
        ("Remote desktop is offline", "遠端迎客桌面已離線"),
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ...
        ("Failed to make direct connection to remote desktop", "無法直接連線到遠端迎客桌面"),
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 RustDesk 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 RustDesk 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的迎客桌面，您需要授予 RustDesk「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的迎客桌面，您需要授予 RustDesk「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ("Installation Path", "安裝路徑"),
        ("Create start menu shortcuts", "新增開始功能表捷徑"),
        ("Create desktop icon", "新增迎客桌面捷徑"),
        ...
        ("Rename", "重新命名"),
        ("Space", "空白"),
        ("Create desktop shortcut", "新增迎客桌面捷徑"),
        ("Change Path", "更改路徑"),
        ("Create Folder", "新增資料夾"),
        ...
        ("elevated_foreground_window_tip", "目前遠端迎客桌面的視窗需要更高的權限才能繼續操作，您暫時無法使用滑鼠和鍵盤，您可以請求對方最小化目前視窗，或者在連線管理視窗點選提升權限。為了避免這個問題，建議在遠端裝置上安裝本軟體。"),
        ("Disconnected", "斷開連線"),
        ("Other", "其他"),
        ...
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland 需要更新版的 Linux 發行版。請嘗試使用 X11 迎客桌面或更改您的作業系統。"),
        ("JumpLink", "查看"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端迎客桌面，請給予 RustDesk「輸入監控」權限。"),
        ...
        ("Strong", "強"),
        ("Switch Sides", "反轉存取方向"),
        ("Please confirm if you want to share your desktop?", "請確認是否要讓對方存取您的迎客桌面？"),
        ("Display", "顯示"),
        ...
        ("View Mode", "瀏覽模式"),
        ("login_linux_tip", "需要登入到遠端 Linux 使用者帳戶才能啟用 X 迎客桌面環境"),
        ("verify_rustdesk_password_tip", "驗證 RustDesk 密碼"),
        ("remember_account_tip", "記住此使用者帳戶"),
        ("os_account_desk_tip", "此使用者帳戶將用於登入遠端作業系統並啟用無頭模式 (headless mode) 的迎客桌面連線"),
        ...
        ("no_desktop_title_tip", "沒有可用的迎客桌面環境"),
        ("no_desktop_text_tip", "請安裝 GNOME 迎客桌面"),
