...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your yingke desktop", "你的迎客桌面"),
        ("desk_tip", "你的迎客桌面可以通过下面的 ID 和密码访问，仅限运行在爱宝机器!"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ...
        ("Request access to your device", "请求访问你的迎客设备"),
        ...
        ("Strong", "强"),
        ("Switch Sides", "反转访问方向"),
        ("Please confirm if you want to share Your yingke desktop?", "请确认是否要让对方访问你的迎客桌面？"),
        ("Display", "显示"),
