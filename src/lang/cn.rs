...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "你的迎客桌面"),
        ("desk_tip", "你的迎客桌面可以通过下面的 ID 和密码访问。"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ...
        ("Control Remote Desktop", "控制远程迎客桌面"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Failed to make direct connection to remote desktop", "无法直接连接到远程迎客桌面"),
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 RustDesk 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的迎客桌面, 请给予 RustDesk \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的迎客桌面, 请给予 RustDesk \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ("Installation Path", "安装路径"),
        ("Create start menu shortcuts", "创建启动菜单快捷方式"),
        ("Create desktop icon", "创建迎客桌面图标"),
        ...
        ("Rename", "重命名"),
        ("Space", "空格"),
        ("Create desktop shortcut", "创建迎客桌面快捷方式"),
        ("Change Path", "更改路径"),
        ("Create Folder", "创建文件夹"),
        ...
        ("elevated_foreground_window_tip", "远端迎客桌面的当前窗口需要更高的权限才能操作, 暂时无法使用鼠标键盘, 可以请求对方最小化当前窗口, 或者在连接管理窗口点击提升。为避免这个问题，建议在远端设备上安装本软件。"),
        ("Disconnected", "会话已结束"),
        ("Other", "其他"),
        ...
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland 需要更高版本的 linux 发行版。 请尝试 X11 迎客桌面或更改您的操作系统。"),
        ("JumpLink", "查看"),
        ...
        ("config_input", "为了能够通过键盘控制远程迎客桌面, 请给予 RustDesk \"输入监控\" 权限。"),
        ...
        ("Strong", "强"),
        ("Switch Sides", "反转访问方向"),
        ("Please confirm if you want to share your desktop?", "请确认是否要让对方访问你的迎客桌面？"),
        ("Display", "显示"),
        ...
        ("View Mode", "浏览模式"),
        ("login_linux_tip", "登录被控端的 Linux 账户，才能启用 X 迎客桌面"),
        ("verify_rustdesk_password_tip", "验证 RustDesk 密码"),
        ("remember_account_tip", "记住此账户"),
        ("os_account_desk_tip", "在无显示器的环境下，此账户用于登录被控系统，并启用迎客桌面"),
        ("OS Account", "系统账户"),
        ...
        ("Remove wallpaper during incoming sessions", "接受会话时移除迎客桌面壁纸"),
        ("Test", "测试"),
